...
\begin{document}
	...
	S10.R5.C2.A1 Thanks. We have added the following text in SXXX. XXX:PhJ:Doit XXX:CL:[I cannot find any text which describes the limitations of using daily averages etc. In sectio 2 of the main manuscript we describe what data we collect, but nothing to do with limitations.]
